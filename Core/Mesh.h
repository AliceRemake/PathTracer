...
{
    NODISCARD FORCE_INLINE static bool ClassOf(const Hittable* ptr) NOEXCEPT {return ptr->Kind() == HITTABLE_TYPE_MESH;}

    NODISCARD explicit Mesh() NOEXCEPT : Hittable(HITTABLE_TYPE_MESH) {}
